...
Reference for java-developer skill. See [SKILL.md](../SKILL.md) for core instructions. For broader test planning and checklists (not Spring-specific), see [test-engineer](../../test-engineer/SKILL.md).
